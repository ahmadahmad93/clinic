            ...
            <div class="row">
                <div class="col-lg-10 col-lg-offset-1 jumbotron"  dir="rtl">
                    ...
                    <div class="col-lg-12">
                        ...
                        <h4 class="text-right alert alert-warning"><span>نص الاستشارة</span></h4>
                        <div class="text-right alert alert-warning"><?php echo $row['body'];?></div>
                        <div class="text-right alert alert-warning">
                            <form action="con_replay.php?id=<?php echo $id;?>" method="post">
                                <label>الرد</label>
                                <textarea name="replay" rows="5" class="form-control">
                                    
                                </textarea>
                                <label></label><br/>
                                <input type="submit" class="btn btn-warning" value="رد" name="submit" />
                            </form>
                        </div>
