...
if (isset($_POST['login'])) {
    $name = $_POST['username'];
    $pwd = $_POST['password'];
    $sql = "SELECT * FROM employees where username='$name' and pwd='$pwd'";
    $query = mysqli_query($conn, $sql);
    if (mysqli_num_rows($query) >= 1) {
        $row = mysqli_fetch_assoc($query);
        switch ($row['section']) {
            case 1:
                header("Location: reciption/index.php");
                break;
            case 2:
            ...
            case 4:
                ...
                break;
            case 5:
                header("Location: consultation/index.php");
                break;
            case 6:
        ...
        <div class="container">
            <section id="content">
                <form action="login.php" method="post">
                    <h1>تسجيل دخول</h1>
                    <div>
                        <input type="text" placeholder="اسم مستخدم" required="" id="username" />
                    </div>
                    <div>
                        <input type="password" placeholder="كلمة مرور" required="" id="password" />
                    </div>
                    <div>
